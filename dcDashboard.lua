...
function scene:createScene( event )
	...
	local bg = display.newImageRect( "background.png", display.contentWidth, display.contentHeight )
	bg.anchorX = 0
	bg.anchorY = 0
	bg:setFillColor( 1 )	-- white
	
	-- create some text
	local title = display.newText( "DC Dashboard", 0, 0, native.systemFont, 32 )
